...
// LocalStorage キー (2級建築士用)
const STORAGE_KEYS = {
    studied: 'kenchikushi_studied',
    difficult: 'kenchikushi_difficult',
    bookmarks: 'kenchikushi_bookmarks',
    darkMode: 'quiz_dark_mode',
    lastStudyDate: 'kenchikushi_last_study_date',
    streak: 'kenchikushi_streak'
};
