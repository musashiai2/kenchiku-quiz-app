...
// LocalStorage キー基底 (令和5年度用) - ユーザープレフィックスは UserManager が付与
const STORAGE_BASE_KEYS = {
    wrongAnswers: 'wrong_r5',
    stats: 'stats_r5',
    bookmarks: 'bookmarks_r5',
    history: 'history_r5',
    adaptiveLearning: 'adaptive_r5',
    studyTime: 'quiz_study_time_r5'
};
