...
// LocalStorage キー基底 (FP2級用) - ユーザープレフィックスは UserManager が付与
const STORAGE_BASE_KEYS = {
    wrongAnswers: 'wrong_fp2',
    stats: 'stats_fp2',
    bookmarks: 'bookmarks_fp2',
    history: 'history_fp2',
    categoryStats: 'category_stats_fp2',
    adaptiveLearning: 'adaptive_fp2',
    studyTime: 'quiz_study_time_fp2'
};
...
// 試験日カウントダウン用キー（FP2級）
const EXAM_DATE_KEY = 'exam_date_fp2';
